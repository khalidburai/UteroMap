# =============================================================================
# SCRIPT 3: PHASE II MACHINE LEARNING PIPELINE
# =============================================================================
...
print("=" * 90)
print("PHASE II: MACHINE LEARNING PIPELINE (EXTENDED DATASET WITHOUT LMP, ENGLISH)")
print("=" * 90)
...
X = phase2_df[feature_cols]
y = phase2_df['_target_num'].astype(int)
...
print("\n" + "=" * 90)
print("PHASE II PERFORMANCE METRICS TABLE (ENGLISH)")
print("=" * 90)
...
plt.title('Phase II: ROC Curves Comparison (Extended Dataset, English)', fontsize=12, fontweight='bold')
plt.legend(loc='lower right', frameon=True)
plt.tight_layout()

roc_path = os.path.join(OUTPUT_DIR, "phase2_roc_curves_English.png")
...
for i, m_name in enumerate(['Random Forest', 'Gradient Boosting']):
    ...
    axes[i].set_title(f'Phase II: {m_name}', fontweight='bold')
    axes[i].set_xlabel('Predicted Label')
    axes[i].set_ylabel('True Label')

plt.tight_layout()
cm_path = os.path.join(OUTPUT_DIR, "phase2_confusion_matrices_English.png")
